...
export default function CTASection() {
  return (
    ...
    >
      <BGPattern variant="checkerboard" mask="fade-center" />
      ...
      <Reveal>
        <div className="max-w-7xl mx-auto space-y-5 flex flex-col items-center">
          ...
          <div className="rounded-xl p-[1px] bg-gradient-to-br from-indigo-500/50 via-rose-500/40 to-amber-400/40 w-full">
          ...
          <WrapButton href="/form" className="mt-1 w-fit">
            Join Now
          </WrapButton>
          <p className="text-xs text-white/40">It takes less than 2 minutes.</p>
        </div>
      </Reveal>
    </section>
  );
