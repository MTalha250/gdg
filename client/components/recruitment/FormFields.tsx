...
export function SelectField({
  ...
  return (
    <FieldShell label={label} required={required} className={className}>
      <div className="relative group">
        <select
          className="appearance-none w-full rounded-xl border border-white/[0.08] bg-black/20 backdrop-blur-sm px-4 py-3 text-white outline-none transition-all duration-200 focus:border-blue/50 focus:bg-black/30 focus:ring-2 focus:ring-blue/20 hover:border-white/20 cursor-pointer"
          value={value}
          onChange={(e) => onChange(e.target.value)}
        >
