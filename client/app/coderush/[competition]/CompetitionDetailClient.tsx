...
const COMPETITION_DATA: Record<string, any> = {
  ...
  "game-jam": {
    ...
    tagline: "5 nights. 1 game. 1 winner.",
    fee: 2500, earlyBird: 2200,
    prizes: ["PKR 20,000", "PKR 10,000"],
    teamSize: "Up to 3 members", duration: "Dev: Tue May 5 (night) → Sat May 9 (midnight) · Evals: Sun May 10 on-campus", format: "Hybrid — remote development + on-campus evaluations",
    overview: "A creative challenge where teams must conceptualize, build, and polish a playable game between Tuesday night and Saturday midnight. A specific theme is announced at the start; teams build remotely, then present and defend their game at on-campus evaluations on Sunday.",
    warning: "Late submissions are NOT qualified for the Best Game prize. Submit before Saturday midnight.",
    sections: [
      { title: "Format & Timeline", items: ["Kickoff — Tuesday, May 5 (Night): Theme announced online; development begins.", "Development Phase: Tuesday night through Saturday — work from home/dorms.", "Submission Deadline — Saturday, May 9 (Midnight): All builds and source code must be submitted.", "Evaluations — Sunday, May 10: On-campus presentation, demo, and judging.", "Theme examples: History, Futuristic, Dystopian, Mythical.", "Genre: Completely free — FPS, survival, co-op, horror, open-world, fighting, etc."] },
      ...
      { title: "Submission", items: ["A. The Build: .exe (Windows), .app (Mac), or Web Link via Google Classroom or Itch.io — by Saturday midnight.", "Late submissions are NOT qualified for the Best Game prize.", "B. Source Code: GitHub. Regular commits required throughout the jam.", "Warning: An empty repo with a massive upload right before the deadline will be flagged as Suspicious Activity."] },
  ...
  "machine-learning": {
    ...
    fee: 2500, earlyBird: 2200,
    prizes: ["PKR 15,000", "PKR 10,000"],
    teamSize: "2–3 members", duration: "Wed May 6 → Fri May 8 (submission) · Evals Sun May 10", format: "Online (remote development + Kaggle submission)",
    overview: "An end-to-end hackathon challenge where teams act as Data Scientists to solve a real-world problem using Classification, Regression, or NLP. Teams must move from raw data to a deployable model — fully online.",
    sections: [
      { title: "Tournament Workflow", items: ["Kickoff — Wednesday, May 6: Problem statement, dataset, and test inputs released. Teams begin remote development.", "Submission Deadline — Friday, May 8 (Night): Teams upload predictions to a private Kaggle leaderboard + push code to GitHub.", "Shortlisting: Top teams advance based on leaderboard metrics (Accuracy, F1, RMSE).", "Evaluations — Sunday, May 10: Final code review and approach evaluation by the jury."] },
      { title: "Logistics & Environment", items: ["Format: Fully online — develop from anywhere.", "Languages Allowed: Python (Primary), R.", "Software: Jupyter Notebooks, Google Colab, Kaggle Kernels.", "Final evaluations on Sunday, May 10 (online or hybrid as per jury)."] },
      { title: "AI Policy & Submission", items: ["AI: ALLOWED for boilerplate/debugging, but logic and analysis must be original.", "Restrictions: No plagiarism from public GitHub repos. No external consultation.", "Submission: Predictions on Kaggle + Code pushed to GitHub + final report via Google/GitHub Classroom by Friday night."] },
  ...
  ctf: {
    ...
    fee: 2500, earlyBird: 2200,
    prizes: ["PKR 15,000", "PKR 10,000"],
    teamSize: "Up to 3 members", duration: "4 hours", format: "On-campus Jeopardy-style CTF",
